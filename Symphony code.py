...
gif_file=Image.open('background.gif')
def play_gif():
    global i,gif_file
...
#making play button
play_image = Image.open("play button-modified.png")
...
#making pause button
play_image2 = Image.open("pause button-modified.png")
...
#making next button
play_image3 = Image.open("next song-modified.png")
...
#making prev button
play_image4 = Image.open("prev song-modified.png")
...
#making back5 button
play_image5 = Image.open("5 sec before button-modified.png")
...
#making back5 button
play_image6 = Image.open("5 sec after button-modified.png")
...
#vol up image:
vol_up= Image.open("vol up-modified.png")
...
#vol down image:
vol_down= Image.open("vol low-modified.png")
...
#FOR LOGO
image_icon=PhotoImage(file="logo Symphony.png")
